...
public class FuncionesConIf {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Precio de envío para cliente 1 con cesta de " + shopcartCustomer1 +
                " € será: " + precioEnvio1 + " €");
        System.out.println("Precio de envío para cliente 2 con cesta de " + shopcartCustomer2 +
                " € será: " + precioEnvio2 + " €");
        System.out.println("Precio de envío para cliente 3 con cesta de " + shopcartCustomer3 +
                " € será: " + precioEnvio3 + " €");
        System.out.println("Precio de envío para cliente 4 con cesta de " + shopcartCustomer4 +
                " € será: " + precioEnvio4 + " €");

        System.out.println("Envío para cesta 130€ para madrid " +
                calcularEnvioUbicacion(130, "Madrid"));
        System.out.println("Envío para cesta 130€ para canarias " +
                calcularEnvioUbicacion(130, "canarias"));
        System.out.println("Envío para cesta 130€ para baleares " +
                calcularEnvioUbicacion(130, "islas baleares"));
    }
